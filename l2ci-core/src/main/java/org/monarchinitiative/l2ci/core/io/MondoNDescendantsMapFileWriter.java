...
public class MondoNDescendantsMapFileWriter {
    private static final Logger LOGGER = LoggerFactory.getLogger(MondoNDescendantsMapFileWriter.class);

    public MondoNDescendantsMapFileWriter(Map<TermId, Integer> mondoNDescMap, String filePath) {
