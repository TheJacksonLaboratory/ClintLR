 ...
 */
public class OntologyTermWrapper implements DiseaseWithProbability {

    private static final double DEFAULT_PRETEST_PROBA = 1.;

    private final Term term;
    private final DoubleProperty sliderValue = new SimpleDoubleProperty(DEFAULT_PRETEST_PROBA);
